<template>
    <f7-page>
        ...
        <f7-block inner>
            ...
            <f7-link icon-f7="gear" text="Configuración gsBase" color="blue" href="/settings"></f7-link>
        </f7-block>
                    ...
                    .then(response => {
                        ...
                        if (response.data.usuario_valido === "ok") {
                            ...
                            let workers_list_big = JSON.parse(
                                this.decodeEntities(JSON.stringify(response.data.ls_completa_trabajadores))
                            );
